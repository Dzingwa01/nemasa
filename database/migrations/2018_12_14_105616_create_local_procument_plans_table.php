...
class CreateLocalProcumentPlansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('local_procument_plans', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('local_procument_plans');
    }
}
