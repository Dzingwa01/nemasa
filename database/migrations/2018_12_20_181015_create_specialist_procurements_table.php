...
class CreateSpecialistProcurementsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('specialist_procurements', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('specialist_procurements');
    }
}
