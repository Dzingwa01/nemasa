...
@section('content')
    <div class="container-fluid">
        ...
        <div class="fixed-action-btn">
            <a class="btn-floating btn-large teal tooltipped modal-trigger" data-position="left" data-tooltip="Add New Package" href="{{url('add-local-procurement-plan/'.$project->id)}}">
    ...
    @push('custom-scripts-contract')
        <script>
            $(document).ready(function () {
                ...
                $(function () {
                    let url ='/get-local-proc-packages/'+project_id;
