                    ...
                    <form class="col s12" >
                        ...
                        <div class="row">
                            <div class="input-field col m6 s12 s12">
                                <input id="package_number" type="text" value="{{$sme_proc->package_number}}" class="validate">
                                <label for="package_number">Package Number</label>
                            </div>
                            <div class="input-field col m6 s12 s12">
                                <textarea id="package_description"  class="materialize-textarea">{{$sme_proc->package_description}}</textarea>
                                <label for="package_description">Description</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col m6 s12 s12">
                                <input id="cibd_grade" type="text" value="{{$sme_proc->cibd_grade}}" class="validate">
                                <label for="cibd_grade">CIBD Grade</label>
                            </div>
                            <div class="input-field col m6 s12">
                                <input id="number_of_targetted_sms" value="{{$sme_proc->number_of_targetted_sms}}" type="number" class="validate">
                                <label for="number_of_targetted_sms">Number of SME(s) Targeted</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col m6 s12">
                                <input id="total_sme_package_est_budget" value="{{$sme_proc->total_sme_package_est_budget}}" type="number" step="0.01" class="validate">
            ...
            <div id="test2">
                <div  style="margin-left: 2em;margin-right: 2em;">
                    <form class="col s12">
                        ...
                        <div class="row">
                            <div class="input-field col m6 s12">
                                <input id="tender_date" value="{{$sme_proc->tender_date}}" type="text" class="datepicker" >
                                <label for="tender_date">Tender Date </label>
                            </div>
                            <div class="input-field col m6 s12">
                                <input id="tender_briefing_date" value="{{$sme_proc->tender_briefing_date}}" type="text" class="datepicker">
                                <label for="tender_briefing_date">Tender Briefing Date</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col m6 s12">
                                <input id="tender_closing_date" value="{{$sme_proc->tender_closing_date}}" type="text" class="datepicker">
                                <label for="tender_closing_date">Tender Closing Date</label>
                            </div>
                            <div class="input-field col m6 s12">
                                <input id="tender_adjudication_report_date" value="{{$sme_proc->tender_adjudication_report_date}}" type="text" class="datepicker">
                                <label for="tender_adjudication_report_date">Tender Adjudication Report Date</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col m6 s12">
                                <input id="tender_review_report_date" type="text" value="{{$sme_proc->tender_review_report_date}}" class="datepicker">
                                <label for="tender_review_report_date">Tender Review Report Date</label>
                            </div>
                            <div class="input-field col m6 s12">
                                <input id="tender_award_date" type="text" class="datepicker" value="{{$sme_proc->tender_award_date}}" class="validate">
            ...
            <div id="test3" >
                <div style="margin-left: 2em;margin-right: 2em;">
                    <form class="col m12">
                        ...
                        <div class="row">
                            <div class="input-field col m6 s12">
                                <input id="name_of_sme_awarded" type="text" value="{{$sme_proc->name_of_sme_awarded}}" class="validate">
                                <label for="name_of_sme_awarded"> Name Of SME Awarded Work Package</label>
                            </div>
                            <div class="input-field col m6 s12">
                                <input id="sme_black_ownership" type="number" class="validate" value="{{$sme_proc->sme_black_ownership}}" />
                                <label for="sme_black_ownership">SME Black Ownership %</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col m6 s12">
                                <input id="sme_award_value" type="number"  step="0.02" value="{{$sme_proc->sme_award_value}}" class="validate">
                                <label for="sme_award_value">SME Award Value</label>
                            </div>
                            <div class="input-field col m6 s12">
                                <input id="sme_work_start_date" type="text" value="{{$sme_proc->sme_work_start_date}}" class="datepicker">
                                <label for="sme_work_start_date">SME Work Start Date</label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="input-field col m6 s12">
                                <input id="sme_work_completion_date" value="{{$sme_proc->sme_work_completion_date}}" type="text" class="datepicker">
                                <label for="sme_work_completion_date">SME Work Completion Date</label>
                            </div>
                            <div class="input-field col m6 s12">
                                <input id="sme_further_sub_contracting" value="{{$sme_proc->sme_further_sub_contracting}}" type="text" class="validate">
    ...
    @push('custom-scripts-contract')
        <script>
            ...
            $(document).ready(function () {
                ...
                let sme_proc = {!! $sme_proc !!};
                console.log("Project",sme_proc);
                if(!sme_proc.id){
                 $('#save-proc-1').show();
                 $('#update-proc-1').hide();
                }else{
                ...
                $('#save-proc-1').on('click',function(){
                    ...
                    $.ajax({
                        ...
                        success: function (response, a, b) {
                            ...
                            $('#cibd_grade').val(response.sme_proc.cibd_grade);
...
//                            $("#modal1").close();
                        ...
                        alert("Enter the SME Package information section first");
                    }
...
//                            $("#modal1").close();
                        ...
                        alert("Please Enter the SME Package Information First");
                    }
                });
